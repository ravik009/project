...
import { Upload, Download, RotateCcw, Zap, Image as ImageIcon, CheckCircle, Edit3, Sparkles, Star, Crown, FileImage, Palette, Settings } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <header className="relative bg-white/80 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden md:flex items-center gap-2 bg-gradient-to-r from-amber-100 to-orange-100 px-3 py-1 rounded-full">
                <Crown className="w-4 h-4 text-amber-600" />
                <span className="text-sm font-medium text-amber-700">Premium Features</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="relative bg-gradient-to-r from-gray-900 to-gray-800 text-white mt-20">
        <div className="max-w-7xl mx-auto px-4 py-16">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold mb-4">See What's Possible</h3>
            <p className="text-gray-300 text-lg mb-10">Professional background removal with Magic Brush editing</p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300">
                <img 
                  ...
                  className="w-full h-56 object-cover rounded-xl mb-4 group-hover:scale-105 transition-transform duration-300"
                />
                <h4 className="font-bold text-lg mb-2">Professional Portraits</h4>
                <p className="text-gray-300 text-sm">Perfect for LinkedIn, resumes, and professional profiles</p>
              </div>
              
              <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300">
                <img 
                  src="https://images.pexels.com/photos/279906/pexels-photo-279906.jpeg?auto=compress&cs=tinysrgb&w=400" 
                  alt="Product photography"
                  className="w-full h-56 object-cover rounded-xl mb-4 group-hover:scale-105 transition-transform duration-300"
                />
                <h4 className="font-bold text-lg mb-2">Product Photography</h4>
                <p className="text-gray-300 text-sm">Clean product shots for e-commerce and marketing</p>
              </div>
              ...
              <div className="group bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300">
                <img 
                  ...
                  className="w-full h-56 object-cover rounded-xl mb-4 group-hover:scale-105 transition-transform duration-300"
                />
                <h4 className="font-bold text-lg mb-2">Creative Photography</h4>
                <p className="text-gray-300 text-sm">Artistic compositions and creative projects</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center border-t border-gray-700 pt-8">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Background Remover Pro</span>
            </div>
            <p className="text-gray-400">
              Powered by advanced AI with Magic Brush professional editing tools
            </p>
          </div>
        </div>
      </footer>
      ...
      {/* Download Modal */}
      {showDownloadModal && processedImage && (
        <DownloadModal
